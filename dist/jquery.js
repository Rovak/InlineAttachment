...
/***/ function(module, exports, __webpack_require__) {
	...
	var jQueryInlineAttachment = function () {
	  function jQueryInlineAttachment(instance, options) {
	    _classCallCheck(this, jQueryInlineAttachment);
	  ...
	  _createClass(jQueryInlineAttachment, [{
	    key: "getValue",
	    ...
	    value: function insertValue(val) {
	      _utils2.default.insertTextAtCursor(this.instance[0], val);
	    }
	  }, {
	    key: "setValue",
	    ...
	    value: function bind() {
	      ...
	      this.instance.bind({
	        ...
	        'dragenter dragover': function dragenterDragover(e) {
	          e.stopPropagation();
	          e.preventDefault();
	        }
	      });
